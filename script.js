document.addEventListener('DOMContentLoaded', () => {
    // --- DATA ---
    const products = [
        { id: 'p1', name: 'Monstera Deliciosa', price: 2900, imageUrl:'assets/images/Monstera Deliciosa.jpeg' , categories: ['beginner'], rating: 4.8, reviewCount: 28, description: 'Known for its iconic split leaves, the Monstera is a fast-growing, easy-care plant that adds a touch of the tropics to any room.', care: 'Loves bright, indirect light. Water when the top 2 inches of soil are dry.', badge: 'New Arrival' },
        { id: 'p2', name: 'Snake Plant', price: 2100, imageUrl: 'assets/images/snake pplant.jpeg', categories: ['beginner', 'low-light', 'pet-friendly'], rating: 4.9, reviewCount: 42, description: 'Almost impossible to kill, the Snake Plant is the perfect choice for beginners. Its stiff, upright leaves are a statement in modern design.', care: 'Thrives on neglect. Tolerates low light and infrequent watering. Let soil dry out completely.', badge: 'On Sale' },
        { id: 'p3', name: 'Fiddle Leaf Fig', price: 4600, imageUrl: 'assets/images/Fiddle Leaf Fig.jpeg', categories: [], rating: 4.5, reviewCount: 19, description: 'A designer favorite, the Fiddle Leaf Fig boasts large, violin-shaped leaves. It\'s a statement piece that requires consistent care.', care: 'Needs bright, consistent, indirect light. Water when the top inch of soil is dry. Avoid drafts.' },
        { id: 'p4', name: 'Golden Pothos', price: 1650, imageUrl: 'assets/images/Golden Pothos.jpeg', categories: ['beginner', 'low-light'], rating: 4.7, reviewCount: 35, description: 'With its trailing heart-shaped leaves, the Pothos is perfect for hanging baskets or shelves. It\'s incredibly resilient and a great air purifier.', care: 'Very adaptable. Can tolerate low light but prefers bright, indirect light. Water when soil is dry.' },
        { id: 'p5', name: 'ZZ Plant', price: 2500, imageUrl: 'assets/images/ZZ Plant.jpeg', categories: ['beginner', 'low-light'], rating: 4.9, reviewCount: 38, description: 'The Zamioculcas Zamiifolia, or ZZ Plant, is a drought-tolerant hero with wide, dark green leaves. It shines in any light condition.', care: 'Extremely low maintenance. Prefers to be dry. Water only when soil is completely dry to the touch.' },
        { id: 'p6', name: 'Spider Plant', price: 1500, imageUrl: 'assets/images/Spider Plant.jpeg', categories: ['beginner', 'pet-friendly'], rating: 4.6, reviewCount: 31, description: 'Famous for its arching leaves and baby "spiderettes," this plant is fun, easy to grow, and a powerful air purifier.', care: 'Prefers bright, indirect light but tolerates lower light. Keep soil evenly moist.' },
        { id: 'p7', name: 'Calathea Orbifolia', price: 3300, imageUrl: 'assets/images/Calathea Orbifolia.jpeg', categories: ['pet-friendly'], rating: 4.4, reviewCount: 15, description: 'A showstopper with large, round leaves striped with silver. Calatheas are known for folding their leaves up at night.', care: 'Needs high humidity and consistently moist soil. Prefers indirect light. Use filtered water.' },
        { id: 'p8', name: 'Bird of Paradise', price: 5400, imageUrl: 'assets/images/Bird of Paradise plant.jpeg', categories: [], rating: 4.7, reviewCount: 22, description: 'Bring a dramatic, tropical vibe indoors with the Bird of Paradise. Its large, banana-like leaves can grow to impressive heights.', care: 'Loves bright light, including some direct sun. Water generously during the growing season.' },
        { id: 'p9', name: 'String of Pearls', price: 1800, imageUrl: 'assets/images/String of Pearls plant.jpeg', categories: [], rating: 4.3, reviewCount: 18, description: 'A unique trailing succulent with pea-shaped leaves. Perfect for hanging planters where its "pearls" can cascade down.', care: 'Needs bright, indirect light and well-draining soil. Water sparingly, allowing soil to dry out.' },
        { id: 'p10', name: 'Rubber Plant', price: 3750, imageUrl: 'assets/images/Rubber Plant.jpeg', categories: ['beginner'], rating: 4.6, reviewCount: 25, description: 'With its striking, glossy leaves, the Rubber Plant is a classic houseplant that\'s easy to care for and makes a bold statement.', care: 'Prefers bright, indirect light. Water when the top inch of soil is dry. Wipe leaves to keep them shiny.' },
        { id: 'p11', name: 'Peace Lily', price: 2300, imageUrl: 'assets/images/Peace Lily.jpeg', categories: ['low-light', 'beginner'], rating: 4.7, reviewCount: 33, description: 'Elegant and graceful, the Peace Lily is known for its beautiful white spathes and ability to thrive in lower light conditions.', care: 'Tolerates low light. Water when the plant starts to droop slightly; it will tell you when it\'s thirsty!' },
        { id: 'p12', name: 'Aloe Vera', price: 1250, imageUrl: 'assets/images/Aloe Vera.jpeg', categories: ['beginner'], rating: 4.8, reviewCount: 40, description: 'A must-have succulent known for its medicinal properties. Its spiky, fleshy leaves are both beautiful and useful.', care: 'Loves bright, direct light. Water deeply but infrequently, allowing the soil to dry out completely.' },
        { id: 'p13', name: 'Jade Plant', price: 2000, imageUrl: 'assets/images/Jade Plant.jpeg', categories: ['beginner'], rating: 4.6, reviewCount: 29, description: 'A popular succulent believed to bring good luck. The Jade Plant has thick, woody stems and glossy, oval-shaped leaves.', care: 'Needs plenty of direct sunlight. Water when the soil is dry to the touch. Avoid overwatering.' },
        { id: 'p14', name: 'Boston Fern', price: 2150, imageUrl: 'assets/images/Boston Fern.jpeg', categories: ['pet-friendly'], rating: 4.4, reviewCount: 17, description: 'With its lush, feathery fronds, the Boston Fern is a classic choice for adding a touch of green elegance and humidity to a room.', care: 'Loves high humidity and bright, indirect light. Keep the soil consistently moist but not waterlogged.' },
        { id: 'p15', name: 'Money Tree', price: 4150, imageUrl: 'assets/images/Money plant.jpeg', categories: ['beginner', 'pet-friendly'], rating: 4.7, reviewCount: 26, description: 'Often with a braided trunk, the Money Tree is another plant thought to bring good fortune. It\'s easy to care for and grows quickly.', care: 'Prefers bright, indirect light. Water thoroughly when the top 1-2 inches of soil are dry.' },
        { id: 'p16', name: 'Pilea Peperomioides', price: 2400, imageUrl: 'assets/images/Pilea Peperomioides.jpeg', categories: ['pet-friendly'], rating: 4.8, reviewCount: 30, description: 'Also known as the Chinese Money Plant, its unique, coin-shaped leaves make it a modern and cheerful addition to any collection.', care: 'Prefers bright, indirect light. Rotate it regularly to keep it from growing lopsided. Water when dry.' },
        { id: 'p17', name: 'Aglaonema', price: 2650, imageUrl: 'assets/images/Aglaonema.jpeg', categories: ['low-light', 'beginner'], rating: 4.6, reviewCount: 21, description: 'The Chinese Evergreen is one of the most durable houseplants, known for its stunning variegated leaves in shades of green, silver, and red.', care: 'Tolerates low light very well. Water when the top 2 inches of soil feel dry.' },
        { id: 'p18', name: 'Dracaena Marginata', price: 3150, imageUrl: 'assets/images/Dracaena Marginata.jpeg', categories: [], rating: 4.5, reviewCount: 16, description: 'A spiky, tree-like plant with slender, arching leaves edged in red. It\'s a great choice for adding height and drama.', care: 'Prefers medium to bright indirect light. Water when the top half of the soil is dry.' },
        { id: 'p19', name: 'Hoya Carnosa', price: 2250, imageUrl: 'assets/images/Hoya Carnosa.jpeg', categories: ['pet-friendly'], rating: 4.7, reviewCount: 23, description: 'The Wax Plant is a beautiful trailing plant with thick, waxy leaves and, if you\'re lucky, clusters of fragrant, star-shaped flowers.', care: 'Loves bright, indirect light. Allow soil to dry out between waterings. It enjoys being slightly root-bound.' },
        { id: 'p20', name: 'Alocasia Polly', price: 3500, imageUrl: 'assets/images/Alocasia Polly.jpeg', categories: [], rating: 4.3, reviewCount: 14, description: 'With its dramatic, arrow-shaped, dark green leaves and prominent silver veins, the Alocasia Polly is a true showpiece.', care: 'Needs bright, indirect light and high humidity. Keep soil consistently moist but not soggy.' },
        { id: 'p21', name: 'Orchid', price: 3200, imageUrl: 'assets/images/Orchid.jpeg', categories: [], rating: 4.6, reviewCount: 20, description: 'A symbol of elegance and beauty, orchids bring a sophisticated touch with their long-lasting, exotic blooms.', care: 'Requires bright, indirect light and specific orchid potting mix. Water thoroughly once the medium is dry.' },
        { id: 'p22', name: 'Anthurium', price: 2800, imageUrl: 'assets/images/Anthurium.jpeg', categories: [], rating: 4.5, reviewCount: 18, description: 'Known for its bright, heart-shaped spathes in red, pink, or white, the Anthurium provides a continuous splash of color.', care: 'Thrives in bright, indirect light. Water when the top inch of soil is dry. Loves humidity.' },
        { id: 'p23', name: 'Croton', price: 2600, imageUrl: 'assets/images/Croton.jpeg', categories: [], rating: 4.4, reviewCount: 15, description: 'A vibrant plant that adds a riot of color with its multi-colored leaves in shades of yellow, red, orange, and green.', care: 'Needs lots of bright, direct light to maintain its colors. Keep soil evenly moist.' },
        { id: 'p24', name: 'Caladium', price: 2900, imageUrl: 'assets/images/Caladium.jpeg', categories: [], rating: 4.3, reviewCount: 12, description: 'With paper-thin, heart-shaped leaves in stunning combinations of pink, white, and green, Caladiums are true works of art.', care: 'Prefers bright, indirect light and high humidity. Keep soil consistently moist.' },
        { id: 'p25', name: 'Syngonium', price: 1800, imageUrl: 'assets/images/Syngonium.jpeg', categories: ['beginner', 'low-light'], rating: 4.6, reviewCount: 24, description: 'The Arrowhead Plant is a fast-growing, easy-care plant with arrow-shaped leaves. It can be kept bushy or allowed to trail.', care: 'Adaptable to various light conditions but prefers bright, indirect light. Water when the top inch of soil is dry.' },
        { id: 'p26', name: 'Maranta', price: 2400, imageUrl: 'assets/images/Maranta.jpeg', categories: ['pet-friendly', 'low-light'], rating: 4.5, reviewCount: 19, description: 'The Prayer Plant is fascinating to watch as its leaves fold up at night. It features beautiful, patterned foliage.', care: 'Prefers bright, indirect light and high humidity. Keep soil consistently moist with filtered water.' },
        { id: 'p27', name: 'Philodendron', price: 2200, imageUrl: 'assets/images/Philodendron.jpeg', categories: ['beginner'], rating: 4.7, reviewCount: 32, description: 'A classic and popular houseplant with heart-shaped leaves. It\'s a vigorous vine that is very easy to grow.', care: 'Prefers medium to bright indirect light. Water when the top half of the soil is dry.' },
        { id: 'p28', name: 'Begonia', price: 2700, imageUrl: 'assets/images/Begonia.jpeg', categories: [], rating: 4.4, reviewCount: 16, description: 'Begonias are prized for their stunningly patterned and uniquely shaped leaves, and some varieties also produce beautiful flowers.', care: 'Prefers bright, indirect light and moderate humidity. Allow the top inch of soil to dry before watering.' },
        { id: 'p29', name: 'Fittonia', price: 1600, imageUrl: 'assets/images/Fittonia.jpeg', categories: ['pet-friendly'], rating: 4.3, reviewCount: 14, description: 'The Nerve Plant has striking leaves with brightly colored veins in pink, white, or red. It loves high humidity.', care: 'Prefers low to medium indirect light and high humidity. Keep soil consistently moist. Great for terrariums.' },
        { id: 'p30', name: 'Peperomia', price: 1900, imageUrl: 'assets/images/Peperomia.jpeg', categories: ['pet-friendly', 'beginner'], rating: 4.6, reviewCount: 22, description: 'A diverse group of small, easy-care plants with interesting foliage. The Watermelon Peperomia is a popular variety.', care: 'Prefers medium to bright indirect light. Allow the soil to dry out between waterings.' },
        { id: 'p31', name: 'Dieffenbachia', price: 3100, imageUrl: 'assets/images/Dieffenbachia.jpeg', categories: [], rating: 4.5, reviewCount: 17, description: 'Also known as Dumb Cane, this plant has large, lush leaves with variegation in shades of cream, yellow, and green.', care: 'Prefers bright, indirect light. Keep soil evenly moist but not waterlogged. Keep away from pets.' },
        { id: 'p32', name: 'Schefflera', price: 3400, imageUrl: 'assets/images/Schefflera.jpeg', categories: [], rating: 4.4, reviewCount: 15, description: 'The Umbrella Tree has glossy, oval leaves that grow in a circular pattern, resembling an umbrella. It\'s a hardy and fast-growing plant.', care: 'Prefers bright, indirect light. Water thoroughly when the top of the soil is dry.' },
        { id: 'p33', name: 'Yucca', price: 4800, imageUrl: 'assets/images/Yucca.jpeg', categories: [], rating: 4.6, reviewCount: 19, description: 'A bold, architectural plant with sword-like leaves that grow from a thick, woody cane. It brings a desert vibe indoors.', care: 'Loves bright light and can handle some direct sun. Allow soil to dry out completely between waterings.' },
        { id: 'p34', name: 'Areca Palm', price: 4200, imageUrl: 'assets/images/Areca Palm.jpeg', categories: ['pet-friendly'], rating: 4.7, reviewCount: 25, description: 'One of the most popular indoor palms, the Areca Palm has graceful, feathery fronds and is an excellent air purifier.', care: 'Prefers bright, indirect light. Keep soil lightly moist but not soggy. Loves humidity.' },
        { id: 'p35', name: 'Kentia Palm', price: 5800, imageUrl: 'assets/images/Kentia Palm.jpeg', categories: ['pet-friendly', 'low-light'], rating: 4.8, reviewCount: 21, description: 'An elegant and resilient palm that can tolerate lower light conditions than most. It has a classic, tropical look.', care: 'Tolerates low light but prefers bright, indirect light. Water when the top 2 inches of soil are dry.' },
        { id: 'p36', name: 'Parlor Palm', price: 3900, imageUrl: 'assets/images/Parlor Palm.jpeg', categories: ['pet-friendly', 'low-light', 'beginner'], rating: 4.7, reviewCount: 28, description: 'A classic, low-maintenance palm that has been popular for decades. It adapts well to indoor conditions.', care: 'Tolerates low light. Water when the top inch of soil is dry. Avoid overwatering.' },
        { id: 'p37', name: 'Ponytail Palm', price: 4500, imageUrl: 'assets/images/Ponytail Palm.jpeg', categories: ['beginner'], rating: 4.6, reviewCount: 18, description: 'Not a true palm, this succulent has a swollen trunk that stores water and long, curly leaves that resemble a ponytail.', care: 'Loves bright light. Allow soil to dry out almost completely between waterings.' },
        { id: 'p38', name: 'Sago Palm', price: 5200, imageUrl: 'assets/images/Sago Palm.jpeg', categories: [], rating: 4.5, reviewCount: 14, description: 'A slow-growing cycad with stiff, feathery fronds. It adds a prehistoric, dramatic look to any space. Toxic to pets.', care: 'Prefers bright, indirect light. Water when the soil is dry to the touch. Be careful not to overwater.' },
        { id: 'p39', name: 'Majesty Palm', price: 5500, imageUrl: 'assets/images/Majesty Palm.jpeg', categories: [], rating: 4.3, reviewCount: 12, description: 'A beautiful palm with graceful, arching fronds. It requires a bit more care, especially with humidity.', care: 'Needs bright, indirect light and consistently moist soil. Loves high humidity.' },
        { id: 'p40', name: 'Bamboo Palm', price: 4900, imageUrl: 'assets/images/Bamboo Palm.jpeg', categories: ['pet-friendly', 'low-light'], rating: 4.6, reviewCount: 20, description: 'With its bamboo-like canes and lush fronds, this palm is an excellent air purifier and adds a touch of the tropics.', care: 'Tolerates low light. Keep soil evenly moist. Appreciates high humidity.' },
        { id: 'p41', name: 'Air Plant', price: 900, imageUrl: 'assets/images/Air Plant.jpeg', categories: ['pet-friendly', 'beginner'], rating: 4.8, reviewCount: 35, description: 'Tillandsias, or Air Plants, don\'t need soil to grow. They can be placed in terrariums, on driftwood, or in special holders.', care: 'Needs bright, indirect light. Soak in water for 20-30 minutes once a week, then let dry completely.' },
        { id: 'p42', name: 'Bromeliad', price: 2800, imageUrl: 'assets/images/Bromeliad.jpeg', categories: ['pet-friendly'], rating: 4.5, reviewCount: 19, description: 'Known for their colorful, long-lasting flower bracts, Bromeliads are easy-care tropical plants.', care: 'Prefers bright, indirect light. Keep the central "cup" of the plant filled with water.' },
        { id: 'p43', name: 'Cactus', price: 1200, imageUrl: 'assets/images/Cactus.jpeg', categories: ['beginner'], rating: 4.7, reviewCount: 30, description: 'A diverse group of succulents known for their unique shapes and low water needs. Perfect for sunny windowsills.', care: 'Needs a lot of direct sunlight. Water very sparingly, allowing the soil to dry out completely.' },
        { id: 'p44', name: 'Succulent', price: 800, imageUrl: 'assets/images/Succulent.jpeg', categories: ['beginner'], rating: 4.8, reviewCount: 40, description: 'Small, charming, and easy to care for, succulents come in a vast array of colors and shapes.', care: 'Needs bright, direct light. Water only when the soil is completely dry.' },
        { id: 'p45', name: 'Kalanchoe', price: 1400, imageUrl: 'assets/images/Kalanchoe.jpeg', categories: [], rating: 4.4, reviewCount: 18, description: 'A cheerful succulent that produces clusters of small, colorful flowers that last for weeks.', care: 'Prefers bright, indirect light. Allow soil to dry out between waterings.' },
        { id: 'p46', name: 'Crown of Thorns', price: 1800, imageUrl: 'assets/images/Crown of Thorns.jpeg', categories: [], rating: 4.3, reviewCount: 15, description: 'A woody, thorny succulent that can bloom almost year-round with small, colorful flowers.', care: 'Needs bright, direct light to flower well. Water when the top inch of soil is dry.' },
        { id: 'p47', name: 'African Violet', price: 1600, imageUrl: 'assets/images/African Violet.jpeg', categories: ['pet-friendly'], rating: 4.5, reviewCount: 22, description: 'A classic flowering houseplant with fuzzy leaves and delicate flowers in shades of purple, pink, and white.', care: 'Prefers bright, indirect light. Water from the bottom to avoid getting the leaves wet. Keep soil moist.' },
        { id: 'p48', name: 'Cyclamen', price: 2200, imageUrl: 'assets/images/Cyclamen.jpeg', categories: [], rating: 4.4, reviewCount: 16, description: 'Known for its upswept petals and beautifully patterned leaves, Cyclamen is a popular cool-season bloomer.', care: 'Prefers bright, indirect light and cool temperatures. Water when the soil feels dry, avoiding the crown.' },
        { id: 'p49', name: 'Gloxinia', price: 2400, imageUrl: 'assets/images/Gloxinia.jpeg', categories: [], rating: 4.3, reviewCount: 13, description: 'With large, velvety, bell-shaped flowers in vibrant colors, Gloxinia is a stunning flowering plant.', care: 'Prefers bright, indirect light. Keep soil evenly moist while in bloom. Avoid getting water on the leaves.' },
        { id: 'p50', name: 'Poinsettia', price: 2600, imageUrl: 'assets/images/Poinsettia.jpeg', categories: [], rating: 4.2, reviewCount: 11, description: 'A holiday favorite, the Poinsettia\'s colorful bracts (modified leaves) are often mistaken for flowers.', care: 'Prefers bright, indirect light. Water when the soil feels dry to the touch.' },
        { id: 'p51', name: 'Amaryllis', price: 2800, imageUrl: 'assets/images/Amaryllis.jpeg', categories: [], rating: 4.6, reviewCount: 19, description: 'Known for its huge, trumpet-shaped flowers on tall stalks, Amaryllis is a spectacular bloomer, often grown from a bulb.', care: 'Prefers bright, indirect light. Water sparingly until growth begins, then keep soil moist.' },
    ];
